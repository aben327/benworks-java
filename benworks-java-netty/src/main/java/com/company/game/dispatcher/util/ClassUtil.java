...
public class ClassUtil {
	...
	/**
	 * 初始化typeToMsgClassMap 遍历包com.company.game.dispatcher.msg 取得消息类的class文件
	...
	/**
	 * 初始化typeToExecutorClassMap 遍历包com.company.game.dispatcher.exec 取得业务逻辑执行器的class文件
	 * @throws ClassNotFoundException
	 * @throws IOException
	 */
	public static void initTypeToExecutorClassMap() throws ClassNotFoundException, IOException {
...
class MyFilter implements FileFilter {
	...
	public boolean accept(File file) {
		return (recursive && file.isDirectory())
				|| (file.getName().endsWith(".class") && file.getName().contains("$") == false && file.getName()
						.startsWith("User"));
	}
}